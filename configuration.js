...
const _gitCommit = 1
const _gitCommitMessage = 'normalising resource ontology : route=virtual&type=desk-schema&thing=' //dev : submodules : test3' //`refactoring : [ /var/task/index.js ]` // mark.js x frameworkDescriptionLogger?
