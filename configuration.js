...
const _gitCommit = 1
const _gitCommitMessage = 'normalising resource ontology : finalising' //dev : submodules : test3' //`refactoring : [ /var/task/index.js ]` // mark.js x frameworkDescriptionLogger?
