...
const gitCommitMessage = `WIP: (uuid4-create.js; CURRENT: onsubmit callback - (browser fetch) doesn't result in (Lambda rawFormString); NEXT: schema name select element) <= housekeeping task to upload CSV to DESKS`
