...
const deleteDeskSchema = async ( data ) => {
    ...
    rus.print.stringify4('debug markup-delete-desk-schema.js', data.RU.request.io.deskSchemasGet)
    return `
        ...
        <pre><code>${ await rus.print.stringify4 ( data.RU.io.deskSchemasGet ) }</code></pre>
