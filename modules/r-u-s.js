...
const { default :  rusMinus1 } = await import ('../modules/r-u-s-minus-1.js')

    console.log(`r-u-s : TOP OF r-u-s`)
    ...
    console.log(`r-u-s : fs, querystring, url, util : imported`)

    console.log(`r-u-s : typeof mark`, typeof rusMinus1.mark)
    ...
    console.log(`r-u-s : before rus assignment`)
    ...
    console.log(`r-u-s : after rus assignment`)

    mark(`LOADED`)

}
catch (e) { console.error(`
( r-u-s : outer 'try' block.`, e) }

console.log(`r-u-s : BOTTOM`)
