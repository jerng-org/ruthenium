            ...
            if (tokenValidationArguments.id_token &&
                ...
                try {
                    tokenValidatedPayloads.id_token = jsonwebtoken.verify(
                        ...
                        idpPemFromJwksIndexed[tokenValidationArguments.id_token.kid], 
                        { algorithms: [tokenValidationArguments.id_token.alg] }
            ...
            if (tokenValidationArguments.access_token &&
                ...
                try {
                    tokenValidatedPayloads.access_token = jsonwebtoken.verify(
                        ...
                        idpPemFromJwksIndexed[tokenValidationArguments.access_token.kid], 
                        { algorithms: [tokenValidationArguments.access_token.alg] }
                        // neglect callback for synchronous call: function ( error, decodedToken )
                    )
                }
                catch (e) {
...
mark (`~/modules/oidcRelyingParty.js LOADED`)